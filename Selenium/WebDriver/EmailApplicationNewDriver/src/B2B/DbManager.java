...
public class DbManager {
	...
	public static CallableStatement cStmt,cStmt1;
	...
	public static List<TableColumnManager> callStoreProcedure() throws SQLException {
		...
		cStmt = con.prepareCall(storedProcudureCall);
	...
	public static void callAwaitingStoreProcedure() throws SQLException {

		//ExcelReader SetinDB = new ExcelReader("D:\\Selenium\\WebDriver\\EmailApplication\\src\\qhid.xlsx");

		// int j1 = rowStart;
		
		System.out.println("Quote Header ID");

		String storedProcudureCall1 = "{call USP_TESTSELENIUMAwaiting" + " "  + SetinDB.getCellData("Sheet1", "QuoteHeaderID", 2) +  " };";

		cStmt1 = con.prepareCall(storedProcudureCall1);
